...
import { AddResearchPackWidgetTypeFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-30/2-30-instance-command-fast-1786320000000-add-research-pack-widget-type';
...
export const INSTANCE_COMMANDS = [
  ...
  AddResearchPackWidgetTypeFastInstanceCommand,
